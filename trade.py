    ...
    def backtest_trade(self,update,vol_update,close_time):
        ...
        for security in securities:
            ...
            if(self.positions[security]['quantity']==0):
                ...
                b,m,u=indicators.bollinger_bands(self.lookback,ltps[security],devs=2)
                ...
                if(update[security]<b):
                    ...
                    charges+=0.0005*self.positions['security']['price']
                ...
                if(position['type']==1):
                    ...
                    if((update[security]>=(1+self.takeprofit)*position['price']) or (update[security]<=(1-self.stoploss)*position['price'])):
                        ...
                        profits+=(update[security]-position['price'])*position['quantity']
                        charges+=0.0005*update[security]
                    ...
                    if((update[security]<=(1-self.takeprofit)*position['price']) or (update[security]>=(1+self.stoploss)*position['price'])):
                        ...
                        profits+=(position['price']-update[security])*position['quantity']
                        charges+=0.0005*update[security]
